...
-- Insert default Users records
 INSERT INTO public.users(user_id, username, first_name, last_name, email_address, create_date, update_date)
 	VALUES (uuid_generate_v4(), 'User1', 'User', 'One', 'User1@gmail.com', current_timestamp, current_timestamp);
 INSERT INTO public.users(user_id, username, first_name, last_name, email_address, create_date, update_date)
    VALUES (uuid_generate_v4(), 'User2', 'User', 'Two', 'User2@gmail.com', current_timestamp, current_timestamp);